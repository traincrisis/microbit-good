...
> Відкрити цю сторінку в [https://traincrisis.github.io/microbit-good/](https://traincrisis.github.io/microbit-good/)
...
* шукайте **https://github.com/traincrisis/microbit-good** та імпортуйте

## Редагувати цей проект ![Значок статусу складання](https://github.com/traincrisis/microbit-good/workflows/MakeCode/badge.svg)

Щоб відредагувати цей репозиторій у MakeCode.

* відкрийте [https://makecode.microbit.org/](https://makecode.microbit.org/)
* клацніть **Імпорт**, потім клацніть **URL-адреса імпорту**
* вставте **https://github.com/traincrisis/microbit-good** і клацніть "Імпорт"
...
![Відрендерене подання блоків](https://github.com/traincrisis/microbit-good/raw/master/.github/makecode/blocks.png)
